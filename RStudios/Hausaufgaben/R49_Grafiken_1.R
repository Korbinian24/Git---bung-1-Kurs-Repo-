...
# t1_start
plot(x = airquality$Temp, y = airquality$Ozone, pch = 16, col = "#FFA50080", las = 1, 
     xlim = c(50, 100), main = "Mehr Ozon an warmen Tagen", 
     cex = airquality$Wind / 5, ylab = "Ø Ozon  [ppb]", xlab = "Temperatur  [°Fahrenheit]")
...
message("DSYMB Ozon  Ø und Temperatur  °Fahrenheit")
...
legend("topleft", legend = leg_wind, title = "Windgeschwindigkeit  [mph]",
       col = "orange", pch = 16 , pt.cex = leg_point_size)
