...
dickeSortiert <- sort(dicke)
# Indizes der sortierten 'hoehe' erhalten
index_sortiert <- order(hoehe)

# Vektoren 'hoehe' und 'dicke' nach 'hoehe' sortieren
hoeheSortiert <- hoehe[index_sortiert]
dickeSortiert <- dicke[index_sortiert]
