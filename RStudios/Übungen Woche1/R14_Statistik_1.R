...
# Neuen Vektor mit geändertem vierten Wert erstellen
werte_neu <- replace(werte, 4, 658)

# Mittelwert mit geändertem vierten Wert berechnen
w_anders_mittel <- mean(werte_neu)

# Median mit geändertem vierten Wert berechnen
w_anders_median <- median(werte_neu)
